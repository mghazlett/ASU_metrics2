...
df <- read_csv("C:/PLE/auth_extension/data/authoritarian_episodes_final.csv", show_col_types = FALSE)
...
write_csv(df_auth, "C:/PLE/auth_extension/data/authoritarian_episodes_refined.csv")
cat("\nSaved: C:/PLE/auth_extension/data/authoritarian_episodes_refined.csv\n")
