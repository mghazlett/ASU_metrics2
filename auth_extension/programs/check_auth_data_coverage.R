...
auth <- read_csv("C:/PLE/auth_extension/data/authoritarian_episodes_refined.csv", show_col_types = FALSE)
...
results %>%
  ...
  write_csv("C:/PLE/auth_extension/data/authoritarian_episodes_scm_viable.csv")
